...
(14,14,128,2048,256,3,3,1,1,1,1),
...
for dataType in (torch.float32,):
    ...
    for w, h, c, n, k, s, r, pad_w, pad_h, wstride, hstride in config:
        ...
        print("A100,Training,%s,Conv2d_fwd,%d,100,1,%d,%d,%d,%d,%d,%d,%d,0.0,%f,None,%f,%f,%f" % (input_tensor.dtype, n, w, h, c, k, s, pad_w, wstride, (sum(forward_pass_time)/n_iters)/n, n/(sum(forward_pass_time)/n_iters), tflops_forw, (sum(forward_pass_time)/n_iters)/n))
