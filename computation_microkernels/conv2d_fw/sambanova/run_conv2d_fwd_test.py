...
for dataType in ("float32",): #np.float32, np.float16,
    ...
    for w, h, c, n, k, s, r, pad_w, pad_h, wstride, hstride in config:
        ...
        str_compile = "python conv2d_fwd.py compile -b " + str(n) + " -mb " + str(n) + " --dtype='" + dataType + "' --inference --w=" + str(w) + " --h=" + str(h) + " --c=" + str(c) + " --n=" + str(n) + " --k=" + str(k) + " --s=" + str(s) + " --r=" + str(r) + " --pad_w=" + str(pad_w) + " --pad_h=" + str(pad_w) + " --wstride=" + str(wstride) + " --hstride=" + str(hstride) + " --output-folder='pef' --pef-name='conv_net'"
        print(str_compile)
        str_execute = "python conv2d_fwd.py run -b " + str(n) + " -mb " + str(n) + " --dtype='" + dataType + "' --inference --w=" + str(w) + " --h=" + str(h) + " --c=" + str(c) + " --n=" + str(n) + " --k=" + str(k) + " --s=" + str(s) + " --r=" + str(r) + " --pad_w=" + str(pad_w) + " --pad_h=" + str(pad_w) + " --wstride=" + str(wstride) + " --hstride=" + str(hstride) + " --pef='pef/conv_net/conv_net.pef'"
        print(str_execute)
