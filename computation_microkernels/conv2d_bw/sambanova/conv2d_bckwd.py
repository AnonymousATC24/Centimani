        ...
        if args.command in ['test', 'measure-performance', 'run', 'measure-sections']:
            ...
            if args.command == 'test':
                ...
                if args.command == 'measure-performance':
                    ...
                    print("SN,Training,%s,Conv2d_bckwd,%d,100,1,%d,%d,%d,%d,%d,%d,%d,0.0,%f,None,%f,%f,%f" % ("dtype", args.n, args.w, args.h, args.c, args.k, args.s, args.pad_w, args.wstride, (sum(forward_pass_time)/n_iters)/args.n, args.n/(sum(forward_pass_time)/n_iters), tflops_forw, (sum(forward_pass_time)/n_iters)/args.n))
